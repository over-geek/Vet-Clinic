...
SELECT owners.full_name, animals.name AS animal_name, species.name AS species_name FROM owners
...
SELECT animals.name AS animal_name, species.name AS species_name, owners.full_name FROM animals
  JOIN species ON animals.species_id = species.id
  JOIN owners ON animals.owner_id = owners.id
...
SELECT owners.full_name, COUNT(*) AS num_animals_owned FROM animals
  JOIN owners ON animals.owner_id = owners.id
  GROUP BY owners.full_name
  ORDER BY num_animals_owned DESC LIMIT 1;